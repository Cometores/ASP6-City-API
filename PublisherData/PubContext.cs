...
public class PubContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var someBooks = new Book[]
        {
            ...
            new Book { BookId = 2, AuthorFK = 2, Title = "A Tale For the Time Being", PublishDate = new DateTime(2013, 12, 31) },
            new Book { BookId = 3, AuthorFK = 3, Title = "The Left Hand of Darkness", PublishDate = new DateTime(1969, 3, 1) }
        };
